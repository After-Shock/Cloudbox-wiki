...
1. Change `"/mnt/local/Media/Movies": 1` to `"/mnt/local/Media/Movies": 2`. This will tell UnionFS Cleaner to not delete the folders immediately under `/mnt/local/Media/Movies` to not be deleted during cleanup.  
