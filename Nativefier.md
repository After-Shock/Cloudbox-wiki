...
- Add Basic HTTP Authentication (replace `yourusername` and `yourpassword` with your login info: 
  ...
  Note: If you plan to use this, set your apps to use HTTP Authentication (i.e. Basic or Browser popup) vs login/form type. Apps that will need changing are: Sonarr, Radarr, NZBGet, NZBHydra, and PlexPy (TauTulli). 
