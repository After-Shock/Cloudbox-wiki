...
_Note 3: For explanation on the purpose of the control file, see the [[FAQ|FAQ#purpose-of-a-control-file-in-plex-autoscan]], but the basic gist is that Plex Autoscan will not remove deleted files out of Plex without it._
