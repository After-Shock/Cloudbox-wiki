...
<pre>
Personally, I add all my indexers in here but don't connect it with Radarr/Sonarr. Instead, I add all my
indexers into Sonarr/Radarr, as well, and use NZBHydra as a separate tool to see what's available online 
and, if need be, to send it directly to NZBGet. `
</pre>
