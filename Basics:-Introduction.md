...
`Plex AutoScan`, in turn, will tell Plex to scan for the newly downloaded TV Show or Movie, by just scanning just the season / movie folders. This will (1), make the media appear in Plex sooner than what a full library scan would have been able to do, and (2), reduce the chances of Google API bans. 
