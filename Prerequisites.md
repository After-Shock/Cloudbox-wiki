...
2. Created an A Record for your subdomains with `*` for host and set the value to your server IP address.
   ...
   _Note 2: If you do not want to use a wildcard entry, you can enter all the subdomains yourself (see [below](Prerequisites#ii-free-domain-name-via-freenomcom))._
