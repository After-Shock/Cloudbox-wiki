...
Get an Ubuntu 16.04 server from a hosting company (eg. Hetzner.de). This has been tested on an AMD64 / INTEL machine. ARM based servers (e.g. Digital Ocean, Scaleway, etc) are not supported.
