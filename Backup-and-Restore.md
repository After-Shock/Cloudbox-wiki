...
**Cloudbox Backup** creates a .tar file of the entire `/opt` folder, which includes all settings and configuration files for the Aocker apps installed with Cloudbox, and uploads it to your Google Drive or Rsync remote. Backup can be ran manually on-demand or scheduled to run automatically.
