...
1. Enable notifications: [PlexPy](First-Time-Install:-PlexPy-(Tautulli)#1-accessing-plexpy) -> Settings -> Notification Agents -> Click the gray "bell" icon next to "Pushover" -> and select when you want to be alerted -> Click "close". The "bell" icon will turn yellow. 
